...
import '../tool/src/config.dart'
    show detectBuildMode, BuildMode, getPackageVersion;
  ...
  await build(args, (input, output) async {
    ...
    if (buildMode == BuildMode.consumer) {
      ...
      try {
        ...
        print(
            '[Agus Maps] You can set AGUS_MAPS_HOME environment variable to use a local SDK');
      }
    } else {
      ...
      print(
          '[Agus Maps] Contributor mode detected. Use "dart run tool/build.dart" to build from source.');
    }
  });
}
