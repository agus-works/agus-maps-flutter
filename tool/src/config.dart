...
class BuildConfig {
  ...
  static const List<String> androidAbis = [
    'arm64-v8a',
    'armeabi-v7a',
    'x86_64'
  ];
...
/// Get DuckDB tag or commit from environment or use default.
String getDuckdbTag() {
  return Platform.environment['DUCKDB_TAG'] ?? BuildConfig.defaultDuckdbTag;
}

/// Get duckdb-spatial tag or commit from environment or use default.
String getDuckdbSpatialTag() {
  return Platform.environment['DUCKDB_SPATIAL_TAG'] ??
      BuildConfig.defaultDuckdbSpatialTag;
}
