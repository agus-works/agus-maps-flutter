...
sharing via Metal and CVPixelBuffer for optimal performance on macOS devices.
  ...
  s.prepare_command = <<-CMD
    ...
    DOWNLOAD_URL="https://github.com/agus-works/agus-maps-flutter/releases/download/v${PLUGIN_VERSION}/agus-binaries-macos-v${PLUGIN_VERSION}.zip"
    TEMP_DIR=$(mktemp -d)
    TEMP_ZIP="${TEMP_DIR}/macos-binaries.zip"
