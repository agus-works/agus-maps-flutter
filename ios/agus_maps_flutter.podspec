...
sharing via Metal and CVPixelBuffer for optimal performance on iOS devices.
  ...
  # Localized type strings used by the core place page (iOS)
  ...
  s.pod_target_xcconfig = {
    ...
    'HEADER_SEARCH_PATHS' => [
      ...
      '"$(PODS_TARGET_SRCROOT)/Frameworks/DuckDB.xcframework/ios-arm64/Headers"',
      '"$(PODS_TARGET_SRCROOT)/Frameworks/DuckDB.xcframework/ios-arm64_x86_64-simulator/Headers"',
    ...
    'GCC_PREPROCESSOR_DEFINITIONS' => '$(inherited) PLATFORM_IPHONE=1',
    # Debug configuration needs DEBUG explicitly defined
    'GCC_PREPROCESSOR_DEFINITIONS[config=Debug]' => '$(inherited) PLATFORM_IPHONE=1 DEBUG=1',
    # Release configuration needs RELEASE and NDEBUG explicitly
    'GCC_PREPROCESSOR_DEFINITIONS[config=Release]' => '$(inherited) PLATFORM_IPHONE=1 RELEASE=1 NDEBUG=1',
    'GCC_PREPROCESSOR_DEFINITIONS[config=Profile]' => '$(inherited) PLATFORM_IPHONE=1 RELEASE=1 NDEBUG=1',
  }
